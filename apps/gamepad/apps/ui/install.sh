...
echo "@reboot /usr/bin/env PHX_SERVER=true PHX_HOST=ammobox.local PORT=4000 DB_PATH=$DATABASE PLATFORM=$PLATFORM SECRET_KEY_BASE=frgvEBs7NY74auQ8ziMVeEIB8XUOYKFs7PfNfpns+1CA3+e+DH5nUHGq1UExr3DH /home/pi/gamepad/bin/gamepad daemon" | sudo tee /etc/cron.d/gamepad >> /dev/null
