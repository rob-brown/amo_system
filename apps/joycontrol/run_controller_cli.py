...
# This file is a copy of the Joycontrol CLI with some additions to support the needed features.
...
def _register_commands_with_controller_state(controller_state, cli):
    ...
    async def press(*args):
        """
        press - Press a button for some duration in ms

        Usage:
            press <button> <interval>
