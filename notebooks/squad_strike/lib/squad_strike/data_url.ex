defmodule SquadStrike.DataURL do
  @doc """
  Decodes a [Data URL](https://developer.mozilla.org/en-US/docs/web/http/basics_of_http/data_urls).

      iex> SquadStrike.DataURL.decode("data:,Hello%2C%20World%21")
      {:ok, "text/plain", "charset=US-ASCII", "Hello, World!"}

      iex> SquadStrike.DataURL.decode("data:text/plain;base64,SGVsbG8sIFdvcmxkIQ==")
      {:ok, "text/plain", "", "Hello, World!"}

      iex> SquadStrike.DataURL.decode("data:text/plain;charset=UTF-8;base64,SGVsbG8sIFdvcmxkIQ==")
      {:ok, "text/plain", "charset=UTF-8", "Hello, World!"}

      iex> SquadStrike.DataURL.decode("data:text/html,%3Ch1%3EHello%2C%20World%21%3C%2Fh1%3E")
  ...
  Encodes the given data as a data URL.
      ...
      iex> SquadStrike.DataURL.encode("Hello, World!", "", :url)
      "data:,Hello%2C%20World!"

      iex> SquadStrike.DataURL.encode("Hello, World!", "text/plain", :url)
      "data:text/plain,Hello%2C%20World!"

      iex> SquadStrike.DataURL.encode("Hello, World!", "text/plain;charset=UTF-8", :base64)
